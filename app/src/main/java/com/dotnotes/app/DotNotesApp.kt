...
class DotNotesApp : Application() {
    ...
    override fun onCreate() {
        ...
        database = Room.databaseBuilder(
            ...
            .addMigrations(NoteDatabase.MIGRATION_1_2, NoteDatabase.MIGRATION_2_3, NoteDatabase.MIGRATION_3_4, NoteDatabase.MIGRATION_4_5)
            .build()
    ...
    private fun createNotificationChannels() {
        ...
        try {
            ...
            mgr?.deleteNotificationChannel("alarm_channel_v4")
            mgr?.deleteNotificationChannel("alarm_channel_v5")
        } catch (_: Exception) {}
    ...
    companion object {
        ...
        const val CHANNEL_ALARM = "alarm_channel_v6"
