...
**Accent color:** Diturunkan dari logo aplikasi (gradient biru)

---

## 1. Logo & Identitas

- Ikon: notebook + pena, gradient biru, rounded-square dengan background putih
...
| Accent (Primary) | `#2F80ED` | Tombol utama, link, elemen aktif |
| Accent (Light) | `#5FA1F5` | Gradient awal (mengikuti logo) |
| Accent (Dark) | `#1B5FC7` | Gradient akhir (mengikuti logo) |
...
| Accent (Primary) | `#5FA1F5` | Lebih terang dari light mode agar kontras cukup di background gelap |
